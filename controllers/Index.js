...
const { getRecomCourseData, changeRecomCourseStatus } = require('../services/RecomCourse');
const { getSliderData, changeSliderStatus} = require('../services/Slider');
const { getCollectionData, changeCollectionStatus } = require('../services/Collection');
const { getTeacherData, changeTeacherStatus, selectStarTeacher } = require('../services/Teacher');
const { getStudentData, changeStudentStatus } = require('../services/Student');
...
class Index {
  ...
  //   const result = await changeRecomStatus(id, status);

  //   if (!result) {
  //     ctx.body = returnInfo(API.CHANGE_RECOM_COURSE_STATUS_FAILED);
  //     return;
  //   }
